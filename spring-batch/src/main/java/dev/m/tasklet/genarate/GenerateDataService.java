package dev.m.tasklet.genarate;
...
public class GenerateDataService implements Tasklet {
    ...
    public List<String> getAllTableNames(DataSource db) {
        ...
        if ("ALL".equals(status)) {
            try (Connection connection = db.getConnection();
                 PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.TABLE.getSql())){
    ...
    private List<String> getAllColumns(Connection connection, String tableName) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.COLUMN_TABLE.getSql())){
